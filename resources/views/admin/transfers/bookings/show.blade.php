...
@section('page-title', 'Transfer Booking Details')
...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.transfers.bookings.index') }}" class="rounded-lg border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition">
            Back to bookings
        </a>
    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-6 grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">{{ optional($booking->transfer_date)->format('d M Y') ?? 'TBD' }} at {{ $booking->pickup_time }}</p>
                </div>
                <div>
