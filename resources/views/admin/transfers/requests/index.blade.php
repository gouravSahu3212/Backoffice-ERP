                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm whitespace-nowrap">
                                <div class="inline-flex items-center gap-2">
                                    <select
                                        class="transfer-status-select border border-gray-200 rounded-md pl-2.5 pr-7 py-1.5 text-xs font-medium text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                                        data-id="{{ $req->id }}"
