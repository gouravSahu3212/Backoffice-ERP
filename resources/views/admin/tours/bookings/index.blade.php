...
@section('content')
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tour Bookings</h1>
            <p class="text-sm text-gray-500 mt-1">Review tour bookings created by agents. Admin users can only view and inspect them.</p>
        </div>

        <form method="GET" action="{{ route('admin.tours.bookings.index') }}" class="w-full lg:w-80">
        ...
        <table class="min-w-full divide-y divide-gray-100">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Tour Date</th>
                ...
                @forelse ($bookings as $booking)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-right text-sm">
                            <a href="{{ route('admin.tours.bookings.show', $booking) }}" class="font-medium text-gray-900 hover:text-gray-600">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="px-4 py-16 text-center text-sm text-gray-500">
                            No tour bookings found yet.
                        </td>
                    </tr>
                @endforelse
            </tbody>
